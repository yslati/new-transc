class Constants {
  ...
  static readonly MAX_WATCHERS = 100;
  static readonly MAX_DISTANCE_FROM_MAP_EDGE = Constants.MAP_WIDTH / 4;
  static readonly STARTING_DELAY = 1200;
  static readonly GAME_PAUSE = 3000;
  static readonly INTERRUPT_DELAY = 10000;
  ...
  static readonly MIDDLE_PADDLE_X =
    Constants.MAP_WIDTH / 2 - Constants.PADDLE_WIDTH / 2;
  ...
  static readonly PADDLE_INIT_Y =
    Constants.MAP_HEIGHT / 2 - Constants.PADDLE_HEIGHT / 2;
  static readonly MIDDLE_PADDLE_INIT_Y =
